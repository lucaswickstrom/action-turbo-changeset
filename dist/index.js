...
const node_child_process_1 = __nccwpck_require__(108);
const zod_1 = __nccwpck_require__(301);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const json = yield (0, node_child_process_1.execSync)(`npx turbo run build --dry-run=json`, {
                cwd: process.cwd(),
                encoding: 'utf-8',
            });
            (0, core_1.debug)(`Output from Turborepo: ${json}`);
            const parsedJson = zod_1.z.object({
                tasks: zod_1.z.array(zod_1.z.object({
                    package: zod_1.z.string(),
                    cacheState: zod_1.z.object({
            ...
            (0, core_1.setOutput)('changeset', output);
